...
public class CardService {
    ...
    private Card parseSingleCard(JsonNode node) {
        ...
        Card.CardType type = Card.CardType.valueOf(node.get("type").asText());
        Card.CardTag tag = Card.CardTag.valueOf(node.get("tag").asText());
        ...
        switch (classType) {
            ...
            case "TROOP":
                return new Troop(id, name, cost, tag,
                        ...
                        Card.AttackScope.valueOf(node.get("attackScope").asText()),
                        Card.MovementSpeed.valueOf(node.get("movementSpeed").asText()),
                        node.get("damage").asInt(),
