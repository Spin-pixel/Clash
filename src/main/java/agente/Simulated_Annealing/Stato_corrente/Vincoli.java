...
public class Vincoli {
    ...
    public Integer nSpells;           // Es: Esattamente 2 incantesimi
    public Integer nBuildings;        // Es: Esattamente 0 edifici
    public Integer nFlyingTroop;        // Es: Esattamente 2 carte che volano
    public Integer nBuildingTarget;   // Es: Esattamente 1 win condition (target buildings)
